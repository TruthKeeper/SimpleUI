    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        switch (checkedId) {
            ...
            case R.id.tab_discover:
                ...
                BarUtils.setStatusBarColorInFragment(this, discoverFragment, getResources().getColor(R.color.colorPrimary));
                break;
            case R.id.tab_mine:
                hide(ft);
                show(2, ft);
                ...
                BarUtils.setStatusBarColorInFragment(this, mineFragment, 0xff6262);
                break;
        }
    }
