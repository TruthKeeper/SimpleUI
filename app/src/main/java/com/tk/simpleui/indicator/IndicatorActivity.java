...
public class IndicatorActivity extends AppCompatActivity {
    ...
    private void refresh() {
        IndicatorView.with()
                ...
                .size(DensityUtil.dp2px(this, 10))
                .point(true)
                .num(msg)
                .bind(iv1);
        IndicatorView.with()
                ...
                .point(false)
                .radius(DensityUtil.dp2px(this, 2))
        ...
        IndicatorView.with()
                ...
                .textSize(10)
                .padding(DensityUtil.dp2px(this, 6))
                .point(false)
                .radius(0)
        ...
        IndicatorView.with()
                ...
                .size(DensityUtil.dp2px(this, 20))
                .bottomMargin(DensityUtil.dp2px(this, 10))
                .point(false)
                .radius(Integer.MAX_VALUE)
                .padding(DensityUtil.dp2px(this, 6))
                .num(msg)
